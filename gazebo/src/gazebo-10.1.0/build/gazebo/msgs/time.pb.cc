...
static void InitDefaultsscc_info_Time_time_2eproto() {
  ...
  {
    void* ptr = &::gazebo::msgs::_Time_default_instance_;
    new (ptr) ::gazebo::msgs::Time();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::gazebo::msgs::Time::InitAsDefaultInstance();
}

GZ_MSGS_VISIBLE ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Time_time_2eproto =
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_time_2eproto = {
  &descriptor_table_time_2eproto_initialized, descriptor_table_protodef_time_2eproto, "time.proto", 60,
...
template<> PROTOBUF_NOINLINE ::gazebo::msgs::Time* Arena::CreateMaybeMessage< ::gazebo::msgs::Time >(Arena* arena) {
  return Arena::CreateInternal< ::gazebo::msgs::Time >(arena);
}
