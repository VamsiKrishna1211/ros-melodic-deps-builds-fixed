...
GZ_MSGS_VISIBLE ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Color_color_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Color_color_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_color_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::gazebo::msgs::Color, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::gazebo::msgs::Color, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::gazebo::msgs::Color, r_),
  PROTOBUF_FIELD_OFFSET(::gazebo::msgs::Color, g_),
  PROTOBUF_FIELD_OFFSET(::gazebo::msgs::Color, b_),
  PROTOBUF_FIELD_OFFSET(::gazebo::msgs::Color, a_),
  0,
  1,
  2,
  3,
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::gazebo::msgs::_Color_default_instance_),
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_color_2eproto = {
  &descriptor_table_color_2eproto_initialized, descriptor_table_protodef_color_2eproto, "color.proto", 82,
...
::PROTOBUF_NAMESPACE_ID::uint8* Color::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000008u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(5, this->_internal_a(), target);
  }
...
template<> PROTOBUF_NOINLINE ::gazebo::msgs::Color* Arena::CreateMaybeMessage< ::gazebo::msgs::Color >(Arena* arena) {
