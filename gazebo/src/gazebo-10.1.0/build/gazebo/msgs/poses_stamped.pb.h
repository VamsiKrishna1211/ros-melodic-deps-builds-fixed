...
#ifndef GOOGLE_PROTOBUF_INCLUDED_poses_5fstamped_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_poses_5fstamped_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_poses_5fstamped_2eproto GZ_MSGS_VISIBLE
...
struct GZ_MSGS_VISIBLE TableStruct_poses_5fstamped_2eproto {
...
extern GZ_MSGS_VISIBLE const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_poses_5fstamped_2eproto;
namespace gazebo {
namespace msgs {
class PosesStamped;
...
class GZ_MSGS_VISIBLE PosesStamped :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:gazebo.msgs.PosesStamped) */ {
 public:
  PosesStamped();
  ...
  inline void Swap(PosesStamped* other) {
  ...
  inline PosesStamped* New() const final {
    return CreateMaybeMessage<PosesStamped>(nullptr);
  }

  PosesStamped* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "gazebo.msgs.PosesStamped";
  }
  private:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_poses_5fstamped_2eproto);
    return ::descriptor_table_poses_5fstamped_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_poses_5fstamped_2eproto;
};
// ===================================================================
...
// required .gazebo.msgs.Time time = 1;
inline bool PosesStamped::_internal_has_time() const {
...
inline ::gazebo::msgs::Time* PosesStamped::_internal_mutable_time() {
  _has_bits_[0] |= 0x00000001u;
  if (time_ == nullptr) {
...
// repeated .gazebo.msgs.Pose pose = 2;
inline int PosesStamped::_internal_pose_size() const {
  return pose_.size();
}
...
inline const ::gazebo::msgs::Pose& PosesStamped::_internal_pose(int index) const {
...
inline ::gazebo::msgs::Pose* PosesStamped::_internal_add_pose() {
  return pose_.Add();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_poses_5fstamped_2eproto
