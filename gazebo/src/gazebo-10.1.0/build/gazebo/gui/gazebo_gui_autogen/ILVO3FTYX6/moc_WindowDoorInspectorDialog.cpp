...
struct qt_meta_stringdata_gazebo__gui__WindowDoorInspectorDialog_t {
    QByteArrayData data[1];
    char stringdata0[39];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_gazebo__gui__WindowDoorInspectorDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_gazebo__gui__WindowDoorInspectorDialog_t qt_meta_stringdata_gazebo__gui__WindowDoorInspectorDialog = {
    {
QT_MOC_LITERAL(0, 0, 38) // "gazebo::gui::WindowDoorInspec..."
...
QT_INIT_METAOBJECT const QMetaObject gazebo::gui::WindowDoorInspectorDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<BaseInspectorDialog::staticMetaObject>(),
    qt_meta_stringdata_gazebo__gui__WindowDoorInspectorDialog.data,
    qt_meta_data_gazebo__gui__WindowDoorInspectorDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *gazebo::gui::WindowDoorInspectorDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_gazebo__gui__WindowDoorInspectorDialog.stringdata0))
