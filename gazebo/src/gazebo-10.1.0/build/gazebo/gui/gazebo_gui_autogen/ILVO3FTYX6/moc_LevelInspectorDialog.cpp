...
struct qt_meta_stringdata_gazebo__gui__LevelInspectorDialog_t {
    QByteArrayData data[1];
    char stringdata0[34];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_gazebo__gui__LevelInspectorDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_gazebo__gui__LevelInspectorDialog_t qt_meta_stringdata_gazebo__gui__LevelInspectorDialog = {
    {
QT_MOC_LITERAL(0, 0, 33) // "gazebo::gui::LevelInspectorDi..."

    },
    "gazebo::gui::LevelInspectorDialog"
};
...
QT_INIT_METAOBJECT const QMetaObject gazebo::gui::LevelInspectorDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<BaseInspectorDialog::staticMetaObject>(),
    qt_meta_stringdata_gazebo__gui__LevelInspectorDialog.data,
    qt_meta_data_gazebo__gui__LevelInspectorDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *gazebo::gui::LevelInspectorDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_gazebo__gui__LevelInspectorDialog.stringdata0))
