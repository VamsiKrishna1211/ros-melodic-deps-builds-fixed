...
struct qt_meta_stringdata_gazebo__gui__ImagesView_t {
    QByteArrayData data[1];
    char stringdata0[24];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_gazebo__gui__ImagesView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_gazebo__gui__ImagesView_t qt_meta_stringdata_gazebo__gui__ImagesView = {
    {
QT_MOC_LITERAL(0, 0, 23) // "gazebo::gui::ImagesView"
...
QT_INIT_METAOBJECT const QMetaObject gazebo::gui::ImagesView::staticMetaObject = { {
    QMetaObject::SuperData::link<TopicView::staticMetaObject>(),
    qt_meta_stringdata_gazebo__gui__ImagesView.data,
    qt_meta_data_gazebo__gui__ImagesView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *gazebo::gui::ImagesView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_gazebo__gui__ImagesView.stringdata0))
