...
set(GAZEBO_PLUGIN_PATH "/usr/lib/gazebo-10/plugins")
...
set(GAZEBO_MEDIA_PATH "/usr/share/gazebo-10/media")

# The model path contains the location on disk where models are stored.
set(GAZEBO_MODEL_PATH "/usr/share/gazebo-10/models")
...
set(GAZEBO_PROTO_PATH
  "/usr/include/gazebo-10/gazebo/msgs/proto")
...
list(APPEND GAZEBO_INCLUDE_DIRS /usr/include/gazebo-10)

list(APPEND GAZEBO_LIBRARY_DIRS /usr/lib)
list(APPEND GAZEBO_LIBRARY_DIRS /usr/lib/gazebo-10/plugins)

list(APPEND GAZEBO_CFLAGS -I/usr/include)
list(APPEND GAZEBO_CFLAGS -I/usr/include/gazebo-10)
...
list(APPEND GAZEBO_LDFLAGS -Wl,-rpath,/usr/lib/gazebo-10/plugins)
list(APPEND GAZEBO_LDFLAGS -L/usr/lib)
list(APPEND GAZEBO_LDFLAGS -L/usr/lib/gazebo-10/plugins)
