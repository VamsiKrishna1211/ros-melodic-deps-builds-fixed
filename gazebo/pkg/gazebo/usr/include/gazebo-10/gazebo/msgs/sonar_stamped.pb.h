...
class GZ_MSGS_VISIBLE SonarStamped :
 ...
 public:
  ...
  ::gazebo::msgs::Sonar* _internal_mutable_sonar();
  public:
...
// required .gazebo.msgs.Time time = 1;
inline bool SonarStamped::_internal_has_time() const {
...
inline ::gazebo::msgs::Time* SonarStamped::_internal_mutable_time() {
  _has_bits_[0] |= 0x00000001u;
  if (time_ == nullptr) {
...
// required .gazebo.msgs.Sonar sonar = 2;
inline bool SonarStamped::_internal_has_sonar() const {
...
inline ::gazebo::msgs::Sonar* SonarStamped::_internal_mutable_sonar() {
  _has_bits_[0] |= 0x00000002u;
  if (sonar_ == nullptr) {
